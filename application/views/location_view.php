...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
      ...
      //  "order": [], //Initial no order.
        ...
        "ajax": {
            "url": "<?php echo site_url('Location_Controller/ajax_list')?>",
            "type": "POST"
        },
...
function delete_type(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Type_Strain_Controller/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                  ...
                  <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3">Strain Type name</label>
                        <div class="col-md-6">
                          <input name="strain_type" placeholder="" class="form-control" type="text">
